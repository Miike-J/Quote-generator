...
async function updateQuoteDDBObject() {
    ...
    try {
        ...
        console.log('error updating quote object in dynamo', error)
    }
}
...
exports.handler = async (event) => {
    ...
    async function getRandomQuote(apiURLInput) {
        ...
        const svgImage = `
          <svg width="${width}" height="${height}">
            ...
            <g>
                ...
                <text id="lastLineOfQuote" x="375" y="120" font-family="Verdana" font-size="30" fill="white" text-anchor="middle">
                  ${tspanElements}
            ...
            <text x="${width / 2}" y="${
          height - 10
        }" class="footerStyles">Developed by @MiikeJ | Quotes from Zenquotes.io</text>
          </svg>
        `;
        ...
        const backgroundImages = [
          ...
          "backgrounds/King-Yna.jpg",
          "backgrounds/SweetMorning.jpg",
        ...
        const image = await sharp(selectedBackgroundImage)
          ...
          try {
            ...
            console.log('error upudating quote object in DynamoDB', error)
          }
